    ...
    def _download_audio(self, search_query: str, ydl_opts: Dict) -> Optional[str]:
        ...
        try:
            with yt_dlp.YoutubeDL(ydl_opts) as ydl:
                ...
                # Find the downloaded file (will be .mp3 after post-processing)
                ...
                # If exact match not found, look in download directory for .mp3 files
                for file in os.listdir(self.download_dir):
                    if file.endswith('.mp3') and os.path.basename(base_path) in file:
